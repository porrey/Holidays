...
namespace Innovative.Holiday.Us.Federal.Tests
{
	public class FederalHolidayTests
	{
		...
		public static IEnumerable<DatePair> NewYearsDays = new DatePair[] { DatePair.Create(2017, 1, 1, 2), DatePair.Create(2018, 1, 1, 1), DatePair.Create(2019, 1, 1, 1), DatePair.Create(2020, 1, 1, 1), DatePair.Create(2021, 1, 1, 1), new DatePair() { Actual = new DateTime(2022, 1, 1), Observed = new DateTime(2021, 12, 31) } };
